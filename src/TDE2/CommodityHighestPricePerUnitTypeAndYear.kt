...
fun main() {
    ...
    val tdeName = "commodityHighestPricePerUnitTypeAndYear"
    ...
    val job = Job(configuration, tdeName).apply {
        ...
        mapperClass = MapCommodityHighestPricePerUnitTypeAndYear::class.java
        reducerClass = ReduceCommodityHighestPricePerUnitTypeAndYear::class.java
...
class MapCommodityHighestPricePerUnitTypeAndYear : Mapper<LongWritable, Text, Text, CommodityUnitTypePriceQtdWritable>() {
...
class ReduceCommodityHighestPricePerUnitTypeAndYear :
