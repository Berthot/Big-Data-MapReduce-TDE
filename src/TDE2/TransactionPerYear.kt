...
fun main() {
    ...
    val tdeName = "transactionPerYear"
    ...
    val job = Job(configuration, tdeName).apply {
        ...
        mapperClass = MapTransPerYear::class.java
        reducerClass = ReduceTransPerYear::class.java
...
class MapTransPerYear : Mapper<LongWritable, Text, Text, LongWritable>() {
...
class ReduceTransPerYear : Reducer<Text, LongWritable, Text, LongWritable>() {
